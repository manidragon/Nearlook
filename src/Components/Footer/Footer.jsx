      ...
      <footer className="py-6 bg-[#fafafa]">
        <div className="container">
            ...
            <div className="col flex items-center justify-center flex-col group w-[15%]">
              <LiaShippingFastSolid
                className="text-[40px] transition-all duration-300
                 group-hover:text-red-500 transition group-hover:-translate-y-3"
              />
          ...
          <div className="footer flex py-8">
            <div className="part1 w-[25%] border-[rgba(0,0,0,0.1)]">
      ...
      <div className="bottomStrip border-t border-[rgba(0,0,0,0.1)] py-3 bg-white">
        <div className="container flex items-center justify-between">
          <ul className="flex items-center gap-2">
            <li className="list-none">
              <Link
                ...
                className="w-[35px] h-[35px] rounded-full 
                        ...
                        group transition-all hover:hover:bg-red-500"
              >
            ...
            <li className="list-none">
              <Link
                ...
                className="w-[35px] h-[35px] rounded-full 
                    border border-[rgba(0,0,0,0.1)] 
                    inline-flex items-center justify-center
                    group transition-all hover:bg-red-500"
              >
            ...
            <li className="list-none">
              <Link
                to="/"
                target="_blank"
                className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] flex items-center justify-center group hover:bg-red-500 transition-all"
              >
          ...
          <div className="flex items-center">
            <img src="/payment-all-6.png" alt="image" />
          </div>
        </div>
      </div>
    </>
